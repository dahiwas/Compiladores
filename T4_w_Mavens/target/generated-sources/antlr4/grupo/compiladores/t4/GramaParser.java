...
public class GramaParser extends Parser {
	...
	public static class Decl_locl_globalContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GramaVisitor ) return ((GramaVisitor<? extends T>)visitor).visitDecl_locl_global(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Valor_constanteContext extends ParserRuleContext {
		...
		public TerminalNode OPEN_CADEIA() { return getToken(GramaParser.OPEN_CADEIA, 0); }
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(175);
			_la = _input.LA(1);
			if ( !(((((_la - 36)) & ~0x3f) == 0 && ((1L << (_la - 36)) & 6643777539L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
