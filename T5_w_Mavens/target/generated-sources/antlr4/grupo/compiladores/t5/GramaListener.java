...
public interface GramaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GramaParser#decl_local_global}.
	 * @param ctx the parse tree
	 */
	void enterDecl_local_global(GramaParser.Decl_local_globalContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaParser#decl_local_global}.
	 * @param ctx the parse tree
	 */
	void exitDecl_local_global(GramaParser.Decl_local_globalContext ctx);
	/**
